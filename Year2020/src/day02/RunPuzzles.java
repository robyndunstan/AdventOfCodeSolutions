...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		System.out.println("Part 1 - Test Case 1: " + (new PasswordPhilosophy()).CountGoodPasswords(testInput1, 1) + " good passwords");
		System.out.println("Part 1 - Puzzle: " + (new PasswordPhilosophy()).CountGoodPasswords(puzzleInput, 1) + " good passwords");
		System.out.println("Part 2 - Test Case 1: " + (new PasswordPhilosophy()).CountGoodPasswords(testInput1, 2) + " good passwords");
		System.out.println("Part 2 - Puzzle: " + (new PasswordPhilosophy()).CountGoodPasswords(puzzleInput, 2) + " good passwords");
	}
