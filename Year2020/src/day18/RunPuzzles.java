...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		...
		System.out.println("Part 1 - Test Case 1: " + oo.DoCalculation(testCase1));
		System.out.println("Part 1 - Test Case 2: " + oo.DoCalculation(testCase2));
		System.out.println("Part 1 - Test Case 3: " + oo.DoCalculation(testCase3));
		System.out.println("Part 1 - Test Case 4: " + oo.DoCalculation(testCase4));
		System.out.println("Part 1 - Test Case 5: " + oo.DoCalculation(testCase5));
		System.out.println("Part 1 - Test Case 6 : " + oo.DoCalculation(testCase6));
		
		long sum = 0;
		for (String s : puzzleInput) {
			sum += oo.DoCalculation(s);
		}
		System.out.println("Part 1 - Puzzle: " + sum);
		
		System.out.println("Part 2 - Test Case 2: " + oo.DoCalculationWithPrecedence(testCase2));
		System.out.println("Part 2 - Test Case 3: " + oo.DoCalculationWithPrecedence(testCase3));
		System.out.println("Part 2 - Test Case 4: " + oo.DoCalculationWithPrecedence(testCase4));
		System.out.println("Part 2 - Test Case 5: " + oo.DoCalculationWithPrecedence(testCase5));
		System.out.println("Part 2 - Test Case 6: " + oo.DoCalculationWithPrecedence(testCase6));

		sum = 0;
		for (String s : puzzleInput) {
			sum += oo.DoCalculationWithPrecedence(s);
		}
		System.out.println("Part 2 - Puzzle: " + sum);
	}

	static String testCase1 = "1 + 2 * 3 + 4 * 5 + 6"; // 71
	static String testCase2 = "1 + (2 * 3) + (4 * (5 + 6))"; // 51, 51
	static String testCase3 = "2 * 3 + (4 * 5)"; // 26, 46
	static String testCase4 = "5 + (8 * 3 + 9 + 3 * 4 * 3)"; // 437, 1445
	static String testCase5 = "5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))"; // 12240, 669060
	static String testCase6 = "((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2"; // 13632, 23340
