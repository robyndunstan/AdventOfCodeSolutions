...
import day07.HandyHaversacks.Bag;

public class RunPuzzles {

	public static void main(String[] args) {
		HandyHaversacks h = new HandyHaversacks(testCase1);
		String searchBag = "shiny gold";
		ArrayList<Bag> containsSearchBag = h.FindContainingBags(searchBag);
		System.out.println("Part 1 - Test Case 1");
		System.out.println("\t" + containsSearchBag.size() + " bags contain " + searchBag);
		PrintBags(containsSearchBag);
		System.out.println("Part 1 - Puzzle");
		h.ParseRules(puzzleInput);
		containsSearchBag = h.FindContainingBags(searchBag);
		System.out.println("\t" + containsSearchBag.size() + " bags contain " + searchBag);
		System.out.println("Part 2 - Test Case 1");
		h.ParseRules(testCase1);
		System.out.println("\t" + searchBag + " contains " + h.CountContainedBags(searchBag) + " other bags");
		System.out.println("Part 2 - Test Case 2");
		h.ParseRules(testCase2);
		System.out.println("\t" + searchBag + " contains " + h.CountContainedBags(searchBag) + " other bags");
		System.out.println("Part 2 - Puzzle");
		h.ParseRules(puzzleInput);
		System.out.println("\t" + searchBag + " contains " + h.CountContainedBags(searchBag) + " other bags");
	}
