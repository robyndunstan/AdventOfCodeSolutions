...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		PassportProcessing p = new PassportProcessing(testCase1);
		System.out.println("Part 2 - Test case 1: " + p.ValidPassportCount() + " valid passports");
		p.ParsePassports(testCase2);
		System.out.println("Part 2 - Test case 2: " + p.ValidPassportCount() + " valid passports");
		p.ParsePassports(puzzleInput);
		System.out.println("Part 2 - Puzzle: " + p.ValidPassportCount() + " valid passports");
	}
