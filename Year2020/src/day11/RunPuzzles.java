...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		SeatingSystem ss = new SeatingSystem(testCase1);
		System.out.println("Part 1 - Test Case 1: " + ss.FinalOccupiedCountNeighbors() + " filled seats");
		ss.ParseData(puzzleInput);
		System.out.println("Part 1 - Puzzle: " + ss.FinalOccupiedCountNeighbors() + " filled seats");
		ss.ParseData(testCase1);
		System.out.println("Part 2 - Test Case 1: " + ss.FinalOccupiedCountVisible() + " filled seats");
		ss.ParseData(puzzleInput);
		System.out.println("Part 2 - Puzzle: " + ss.FinalOccupiedCountVisible() + " filled seats");
	}
