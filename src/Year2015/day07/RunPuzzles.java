...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		ArrayList<TestCase<String[], String[]>> testCases = createTestCases();
		System.out.println("Day 07: Some Assembly Required\r\tSection 1");
		int testCaseCount = 0;
		for (TestCase<String[], String[]> test : testCases) {
			if (test.section == 1) {
				testCaseCount++;
	...
	private static ArrayList<TestCase<String[], String[]>> createTestCases() {
		ArrayList<TestCase<String[], String[]>> tests = new ArrayList<TestCase<String[], String[]>>();
		tests.add(new TestCase<String[], String[]>(1, test1, result1));
		return tests;
	}
