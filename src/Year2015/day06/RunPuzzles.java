...
public class RunPuzzles {
	...
	public static void main(String[] args) {
		...
		System.out.println("Day 06: Probably a Fire Hazard\r\tSection 1");
		int testCaseCount = 0;
		for (TestCase<String[], Integer> test : testCases) {
			if (test.section == 1) {
				testCaseCount++;
				System.out.println("\t\tTest " + testCaseCount + "\tExpected: " + test.result + "\tActual: " + ProbablyAFireHazard.getLightCount(test.input));
			}
		}
		System.out.println("\t\tPuzzle: " + ProbablyAFireHazard.getLightCount(puzzleInput));
		...
		for (TestCase<String[], Integer> test : testCases) {
			if (test.section == 2) {
				testCaseCount++;
				System.out.println("\t\tTest " + testCaseCount + "\tExpected: " + test.result + "\tActual: " + ProbablyAFireHazard.getLightSum(test.input));
			}
		}
		System.out.println("\t\tPuzzle: " + ProbablyAFireHazard.getLightSum(puzzleInput));
	}
