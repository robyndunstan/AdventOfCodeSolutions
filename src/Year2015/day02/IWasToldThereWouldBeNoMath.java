...
public class IWasToldThereWouldBeNoMath extends tools.RunPuzzle {

	public IWasToldThereWouldBeNoMath(int dayNumber, String dayTitle, Object puzzleInput) {
		super(dayNumber, dayTitle, puzzleInput);
	}

	public static void main(String[] args) {
		RunPuzzle puzzle = new IWasToldThereWouldBeNoMath(2, "I Was Told There Would Be No Math", puzzleInput);
		puzzle.run();
	}
	...
	public Object doProcessing(int section, Object input) {
		String[] packageDimensions = (String[])input;
		if (section == 1) {
			return getSumPaperNeeded(packageDimensions);
		}
		else {
			return getSumRibbonNeeded(packageDimensions);
		}
	}
	
	private int getSumPaperNeeded(String[] input) {
		int sum = 0;
		for (String in : input) {
	...
	private int getSumRibbonNeeded(String[] input) {
		int sum = 0;
		for (String in : input) {
	...
	private int getPaperNeeded(int[] present) {
	...
	private int getRibbonNeeded(int[] present) {
	...
	private int[] parseOneInput(String input) {
		input = input.trim();
		int[] dims = new int[3];
	...
	private static String[] testInput1 = {"2x3x4"};
	private static String[] testInput2 = {"1x1x10"};
